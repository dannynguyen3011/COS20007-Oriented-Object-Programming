...
namespace TestProject
{
    ...
    public class TestLook
    {
        ...
        public void TestLookAtMe()
        {
            ...
            string exppected = "You are MD a real warrior";
            string actual = l.Excecute(p, new string[] { "look", "at", "inventory" });

            Assert.That(actual, Is.EqualTo(exppected), "TestLookCommand can look for 'inventory' and return player description");
